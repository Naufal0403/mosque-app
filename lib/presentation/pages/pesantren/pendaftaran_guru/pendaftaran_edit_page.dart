...
class PendaftaranGuruEditPage extends StatefulWidget {
  const PendaftaranGuruEditPage({Key? key}) : super(key: key);

  @override
  State<PendaftaranGuruEditPage> createState() =>
      _PendaftaranGuruEditPageState();
}

class _PendaftaranGuruEditPageState extends State<PendaftaranGuruEditPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        elevation: 0,
        title: Text('Pesantren > Guru > Tambah'),
