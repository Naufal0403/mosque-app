...
class PendaftaranGuruCreate extends StatefulWidget {
  const PendaftaranGuruCreate({Key? key}) : super(key: key);

  @override
  State<PendaftaranGuruCreate> createState() => _PendaftaranGuruCreateState();
}

class _PendaftaranGuruCreateState extends State<PendaftaranGuruCreate> {
  String? gender;
