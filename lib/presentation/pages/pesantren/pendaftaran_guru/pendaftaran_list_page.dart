...
import 'package:flutter_api/presentation/pages/pesantren/pendaftaran_guru/pendaftaran_create_page.dart';
import 'package:flutter_api/presentation/pages/pesantren/pendaftaran_guru/pendaftaran_edit_page.dart';
...
class PendaftaranGuruListPage extends StatefulWidget {
  const PendaftaranGuruListPage({Key? key}) : super(key: key);

  @override
  State<PendaftaranGuruListPage> createState() =>
      _PendaftaranGuruListPageState();
}

class _PendaftaranGuruListPageState extends State<PendaftaranGuruListPage> {
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.push(
                context,
                (MaterialPageRoute(
                  builder: (context) => PendaftaranGuruCreate(),
                )),
              );
            },
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PendaftaranGuruEditPage(),
                      ),
                    );
                  },
                  child: Icon(
