...
class PendaftaranCreatePage extends StatefulWidget {
  const PendaftaranCreatePage({Key? key}) : super(key: key);

  @override
  State<PendaftaranCreatePage> createState() => _PendaftaranCreatePageState();
}

class _PendaftaranCreatePageState extends State<PendaftaranCreatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        elevation: 0,
        title: Text('Pesantren > Pendaftaran > Siswa'),
