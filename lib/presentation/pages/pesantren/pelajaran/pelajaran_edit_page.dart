...
class PelajaranEditPage extends StatefulWidget {
  const PelajaranEditPage({Key? key}) : super(key: key);

  @override
  State<PelajaranEditPage> createState() => _PelajaranEditPageState();
}

class _PelajaranEditPageState extends State<PelajaranEditPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        elevation: 0,
        title: Text('Pesantren > Pelajaran > Edit'),
